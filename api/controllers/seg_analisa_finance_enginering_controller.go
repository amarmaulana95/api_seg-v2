...
func (server *Server) SegAnalisaFinanceEngineringInsert(w http.ResponseWriter, r *http.Request) {
	if (*r).Method == "OPTIONS" {
		return
	}
	...
	rSegAnalisaMethod.Id_analisa_type = 4
...
func (server *Server) SegAnalisaFinanceEngineringAll(w http.ResponseWriter, r *http.Request) {
	if (*r).Method == "OPTIONS" {
		return
	}
	...
	dsemethod, err := semethod.FindAllSegAnalisaMethodsFull(server.DB, uint32(4), search, limit, offset)
	if err != nil {
		responses.ERROR(w, http.StatusInternalServerError, err)
		return
	}
	...
	dsemethodTotal := semethod.FindAllSegAnalisaMethodsTotal(server.DB, uint32(4), search)
...
func (server *Server) SegAnalisaFinanceEngineringDelete(w http.ResponseWriter, r *http.Request) {
	if (*r).Method == "OPTIONS" {
		return
	}
...
func (server *Server) SegAnalisaFinanceEngineringAttachmentDelete(w http.ResponseWriter, r *http.Request) {
	if (*r).Method == "OPTIONS" {
		return
	}
	...
	_, err = samethodattach.DeleteSegAnalisaMethodAttachment(server.DB, uint32(uid), 4)
	if err != nil {
		responses.ERROR(w, http.StatusInternalServerError, err)
		return
	}
...
func (server *Server) SegAnalisaFinanceEngineringExceptionDelete(w http.ResponseWriter, r *http.Request) {
	if (*r).Method == "OPTIONS" {
		return
	}
	...
	_, err = samethodattach.DeleteSegAnalisaMethodException(server.DB, uint32(uid), 4)
	if err != nil {
		responses.ERROR(w, http.StatusInternalServerError, err)
		return
	}
...
func (server *Server) SegAnalisaFinanceEngineringDetailDelete(w http.ResponseWriter, r *http.Request) {
	if (*r).Method == "OPTIONS" {
		return
	}
	...
	_, err = samethodattach.DeleteSegAnalisaMethodDetail(server.DB, uint32(uid), 4)
	if err != nil {
		responses.ERROR(w, http.StatusInternalServerError, err)
		return
	}
...
func (server *Server) SegAnalisaFinanceEngineringUpdate(w http.ResponseWriter, r *http.Request) {
	if (*r).Method == "OPTIONS" {
		return
	}
